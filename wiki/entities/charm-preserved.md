...
> RCT of candesartan (ARB) vs. placebo in HF with LVEF >40%; missed primary endpoint; hospitalization trend observed; established the HFpEF trial failure pattern before modern phenotyping.
...
- **Population:** HF with LVEF >40% — predates modern phenotyping; includes what would now be classified as [[hfmref]] and [[hfpef]]
- **Primary endpoint:** CV death + HF hospitalization
- **Full paper stub:** [[yusuf2003charm]]
...
- Entities: [[hfpef]], [[hfmref]], [[topcat]], [[paragon-hf]], [[i-preserve]]
- Sources: [[mcdonagh2021esc]], [[yusuf2003charm]]
