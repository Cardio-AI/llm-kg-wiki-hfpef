...
| Variable | HIIT (n=10) | MCT (n=9) |
|---|---|---|
| Mean age | 60±9 years | ~60 years |
| Female | 63% | ~63% |
| LVEF | >50% | >50% |
| E/e' | >15 (or 8–15 + elevated NP) | — |
| NYHA | II–III | II–III |
...
| Outcome | HIIT | MCT | P (between-group) |
|---|---|---|---|
...
- Very small sample (N=19 analysed); significant attrition from N=24
- Single-centre (Brazil); may not generalise to older/more comorbid European/North American HFpEF populations
- Short duration (12 weeks); no long-term follow-up
- E/e' not a hard outcome; no mortality/hospitalisation data

---

## Connections

- Updates: [[supervised-exercise-training]] — HIIT > MCT for VO₂ in this small RCT; contradicted by larger OptimEx-Clin
- Updates: [[exercise-intolerance]] — exercise improves VO₂ and diastolic markers in HFpEF
- Contradicts: [[mueller2021optimex]] — OptimEx-Clin (N=180) found HIIT not superior to MCT; DonelliDaSilveira found HIIT significantly better; difference may reflect sample size and population
...
- Sources: [[mueller2021optimex]], [[sachdev2023exercise]], [[prokopidis2025exercise]]

---

## Contradictions

HIIT superiority over MCT found here (N=19) conflicts with null HIIT vs MCT difference in OptimEx-Clin (N=180). The larger, multi-site, pre-registered OptimEx-Clin result is more reliable. See [[contradictions]].
