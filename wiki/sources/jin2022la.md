...
- Search: MEDLINE + EMBASE from inception to February 2021; English language
- Inclusion: HFrEF and/or HFpEF with LA structural/functional echo data; LVEF cut-off ≥45% or ≥50% for HFpEF
- 61 studies included: 27 studies with only HFrEF (n=8,806); 38 studies with only HFpEF (n=9,928); 9 studies with both
- Quality assessment: Newcastle-Ottawa Scale for observational studies; Cochrane RoB 2.0 for RCTs
- Statistical: weighted mean differences (WMD); 95% CI; random effects meta-analysis

---

## Relevance to HFpEF Wiki

This is the largest meta-analysis of echocardiographic LA characterisation across HF phenotypes. Key implications:
- **LAVi alone cannot differentiate HFrEF from HFpEF** — reinforces the need for functional LA metrics (strain) for phenotype distinction
- **LA strain (LAGLS_R) is a promising differential biomarker** — markedly better in HFpEF vs HFrEF, and LAGLS_R–LAVi coupling is phenotype-specific
- **AF prevalence paradox** in HFpEF (more AF, better LA function) supports the LA myopathy hypothesis underlying AF-HFpEF co-occurrence

---

## Connections

- Updates: [[atrial-fibrillation]] — higher AF prevalence in HFpEF despite better LA global function; LA myopathy model
- Updates: [[cardiac-mri]] — LA strain assessment adds beyond LAVi for HFpEF characterisation
- Supports: [[hfpef]] — distinct LA physiology in HFpEF vs HFrEF
- Relevant to: HFA-PEFF algorithm ([[pieske2019hfapeff]]) — LA parameters in diagnostic scoring
...
- Entities: [[atrial-fibrillation]], [[cardiac-mri]]
- Sources: [[pieske2019hfapeff]], [[reddy2018h2fpef]]

---

## Contradictions

LA myopathy as a distinct driver of AF in HFpEF (vs. AF as a consequence of LA dilatation from elevated LV filling pressure in HFrEF) — this mechanistic distinction has implications for rate vs rhythm control strategies but lacks RCT evidence. See [[contradictions]].
