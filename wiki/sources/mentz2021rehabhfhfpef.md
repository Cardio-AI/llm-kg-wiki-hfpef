...
- Pre-specified subgroup analysis of REHAB-HF (NCT02196038)
- HFpEF defined as LVEF ≥45% (N=185); HFrEF as LVEF <45% (N=164)
- Same intervention: transitional progressive multidomain rehabilitation (36 outpatient sessions over 12 weeks)
- Global rank endpoint: hierarchical composite (death > rehospitalisation > SPPB change); analysed by win ratio / probability index

---

## Results

| Endpoint | HFpEF effect | HFrEF effect | Interaction P |
|---|---|---|---|
| SPPB at 3 months | +1.9 (1.1–2.6) | +1.1 (0.3–1.9) | 0.25 |
| 6MWD at 3 months | +40 m | +27 m | NS |
...
- Subgroup analysis: not powered to detect EF interaction; interaction P values non-significant
- Wide confidence intervals for mortality; cannot draw conclusions on survival
- HFpEF defined as LVEF ≥45% — may include some HFmrEF
- Single-blind design; predominantly Black population (97%)

---

## Connections

- Updates: [[supervised-exercise-training]] — HFpEF-specific effect from post-hospitalisation rehab
- Updates: [[rehab-hf]] — EF subgroup analysis of main trial
- Supports: [[exercise-intolerance]] — HFpEF patients more physically impaired, more to gain from rehabilitation

---

## Secondary Analyses & Data Reuse

Subanalysis of [[kitzman2021rehabhf]] (parent trial).
...
Interaction P=0.098 for global rank endpoint — the finding of HFpEF-specific benefit is suggestive but not formally significant. See [[contradictions]].
