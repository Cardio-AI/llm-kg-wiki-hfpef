...
- PROSPERO 2023 CRD42023427519; search to May 19, 2023
- Databases: EMBASE and MEDLINE (Ovid)
- Included: RCTs or observational cohort studies; HFpEF (LVEF ≥50%); beta-blocker vs placebo/control/standard care; follow-up ≥6 months
- Excluded: AF- or arrhythmia-only populations; post-MI or valve surgery populations
- Quality assessment: ROBINS-I for observational; RoB2 for RCTs

---

## Key Studies Included

| Study | N | Design | Duration | OR mortality |
|---|---|---|---|---|
| Bitar 2021 | 211 | Cohort | NR | 0.59 (0.33–1.05) |
| Farasat 2010 | 66 | Cohort | NR | 0.25 (0.02–2.92) |
| Formiga 2022 | 1,188 | Cohort | NR | 0.93 (0.67–1.31) |
| Lam 2018 | 1,280 | Cohort | NR | 0.78 (0.62–0.99) |
...
- Beta-blockers are among the most commonly prescribed drugs in HFpEF (60–80% of patients in registries) despite no proven mortality benefit
- The observational association with reduced mortality likely reflects confounding; beta-blockers are prescribed to healthier, more haemodynamically stable patients
- The question of whether beta-blockers are beneficial, neutral, or harmful in HFpEF (via chronotropic incompetence mechanism) remains unresolved and is a major knowledge gap
- The SENIORS trial (nebivolol) is the only large RCT with even partial HFpEF data (15% had LVEF >50%) — insufficient for a conclusion

---

## Connections

- Updates: [[hfpef]] — beta-blocker use common but not proven beneficial; chronotropic incompetence concern
- Supports: [[hfpef-treatment-gap]] — beta-blockers not proven in HFpEF
- Relevant to: [[vandebovenkamp2025hemodynamics]] — beta-blockers increased SV in HFrEF but not HFpEF in meta-analysis of RCT hemodynamic data
...
The significant mortality reduction in pooled observational data (OR 0.81) likely reflects confounding by indication rather than a causal treatment effect. A large RCT of beta-blockers in unselected HFpEF is needed. See [[contradictions]].
