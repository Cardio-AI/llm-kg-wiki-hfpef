...
- PROSPERO CRD42021219845; search inception to June 2024
- Databases: PubMed, EMBASE, Google; no language restriction
- Included: observational studies and RCTs; HFpEF adults; BNP/NT-proBNP exposure; adverse outcomes (CV events, hospitalization, thromboembolic events, death)
- 22 studies included; 10,158 HFpEF patients; age range 44–82 years
- Quality: Newcastle-Ottawa Scale (NOS), scores 7–9 (moderate to high)

---

## Relevance to HFpEF Wiki

- Establishes NP-based prognostic stratification in HFpEF analogous to HFrEF — elevated BNP/NT-proBNP identifies higher-risk HFpEF patients
- The "obesity paradox" in BNP (lower BNP despite worse outcomes in obese HFpEF) has implications for the STEP-HFpEF/SUMMIT obesity trials where NT-proBNP entry criteria were used
- Provides cut-off data (BNP ≥100 pg/mL, NT-proBNP 300–623 pg/mL) relevant to clinical risk stratification and potential trial design

---

## Connections

- Updates: [[hfpef]] — BNP/NT-proBNP are independent prognostic biomarkers in HFpEF
- Updates: [[overview]] — natriuretic peptides have prognostic value even in HFpEF where they are often lower than in HFrEF
- Relevant to: obesity-HFpEF phenotype ([[step-hfpef]], [[summit]]) — obesity suppresses BNP despite haemodynamic burden
...
- Entities: [[hfpef]]
- Sources: [[fu2024inflammation]], [[reddy2018h2fpef]], [[pieske2019hfapeff]]

---

## Contradictions

Paradox: low BNP in HFpEF indicates poor prognosis (opposite of HFrEF pattern) — likely driven by the obesity-HFpEF phenotype where adiposity suppresses BNP secretion. Standardised BNP thresholds across HFpEF trials are inconsistent; the meta-analysis pooled studies using heterogeneous cut-offs and follow-up durations. See [[contradictions]].
