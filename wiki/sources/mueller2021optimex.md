...
**Full title:** Optimising Exercise Training in Prevention and Treatment of Diastolic Heart Failure (OptimEx-Clin)  
**NCT:** NCT02078947  
**Sites:** 5 European centres  
**Design:** Three-arm, single-blind RCT  
**Intervention arms:**
  - HIIT: 3 sessions/week × 38 min each at 80–90% HRR; intervals 4×4 min; 3 months supervised
  - MCT: 5 sessions/week × 40 min each at 35–50% HRR; 3 months supervised
  - Guideline control: single exercise counselling session per current guidelines
  - Months 4–12: telemedically-supervised home training for both exercise arms
**Population:** HFpEF (LVEF ≥50%), NYHA II–III, age ≥18, confirmed diastolic dysfunction  
**Primary endpoint:** Change in peak VO₂ from baseline to 3 months  
**Publication:** JAMA 2021;325(6):542–551
...
| Endpoint | HIIT vs control | MCT vs control | HIIT vs MCT |
|---|---|---|---|
| Peak VO₂ at 3 months | +1.5 (0.4–2.7), P=0.01 | +2.0 (0.9–3.1), P=0.001 | −0.4 (−1.4 to 0.6), NS |
| Peak VO₂ at 12 months | NS | NS | NS |
| E/e' at 3 months | NS | NS | NS |
...
- Telemedically-supervised home training from months 4–12 may have led to reduced exercise compliance contributing to loss of gains
- MCID threshold of 2.5 mL/kg/min may be conservative; both arms showed clinically meaningful improvements
- Single-blind design; exercise intensity validation based on HR monitoring
- European multicentre population — may differ from US HFpEF cohorts in age, comorbidities
...
- Extends: [[optimex-clin]] — main results paper
...
|---------|-------|-----------|
| [[donelli2020hiit]] | Smaller Brazilian HIIT vs MCT RCT with consistent findings | [[donelli2020hiit]] |
...
Consistent with DonelliDaSilveira 2020 (HIIT numerically better VO₂ but not clearly superior to MCT in HFpEF). Inconsistent with some meta-analyses suggesting HIIT superiority in HFrEF. See [[contradictions]].
