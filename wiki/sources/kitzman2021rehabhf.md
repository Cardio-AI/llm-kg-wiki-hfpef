...
**Full title:** Rehabilitation Therapy in Older Acute Heart Failure Patients  
**NCT:** NCT02196038  
**PI/Sponsor:** Dalane Kitzman, Wake Forest University  
**Design:** Multicentre (4 sites), randomised, single-blind, controlled trial  
**Intervention:** Transitional progressive multidomain rehabilitation: in-hospital sessions initiated within 2 days of admission; 36 supervised outpatient sessions over 12 weeks; modalities include resistance exercise, balance training, mobility training, and endurance walking; intensity progressed based on SPPB  
**Control:** Usual care (no structured exercise)  
**Population:** Age ≥60, hospitalised for ADHF, LVEF-unspecified (any EF), functionally independent at home prior to hospitalisation, able to walk ≥4 m  
**Primary endpoint:** SPPB at 3 months  
**Key secondary endpoints:** Rehospitalisation (composite 60-day), 6MWD, KCCQ, depression (PHQ-9), frailty, body composition  
**Publication:** N Engl J Med 2021;385:203–216
...
|---|---|---|
| Age (mean) | ~72.7 years | ~72.7 years |
| Female | 52% | 52% |
| Black race | 97% | 97% |
| Frail or pre-frail | 97% | 97% |
| LVEF ≥45% (HFpEF) | 53% | 53% |
| Number of comorbidities | ~5 | ~5 |
| SPPB at baseline | ~5.5 | ~5.5 |
| 6MWD at baseline | ~200 m | ~200 m |

---

## Results

| Endpoint | Rehab | Usual Care | Difference (95% CI) | P |
|---|---|---|---|---|
...
- Single-blind (patients not blinded); difficult to blind exercise interventions
- 97% Black race at 4 US sites; generalisability to other racial/ethnic groups uncertain
- Underpowered for rehospitalisation and mortality
- No control for potential Hawthorne effect in rehabilitation visits
- No follow-up assessment beyond 6 months; durability of functional gains unknown
...
- Supports: [[hfpef]] — multidomain rehab feasible and effective in HFpEF
- Secondary analysis: [[mentz2021rehabhfhfpef]] — EF subgroup analysis showing nominally larger benefit in HFpEF
...
|---------|-------|-----------|
| [[mentz2021rehabhfhfpef]] | HFpEF vs HFrEF subgroup analysis; global rank endpoint | [[mentz2021rehabhfhfpef]] |
...
None internal. The lack of effect on rehospitalisation despite significant functional improvement is consistent with the broader HFpEF pattern of surrogate improvement without hard endpoint benefit. See [[contradictions]].
