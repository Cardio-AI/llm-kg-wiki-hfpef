...
A cascading model from risk factors to clinical syndrome:

```
Risk factors (aging, HTN, obesity, DM, CAD)
   ↓
Tissue pathology:
  - Systemic inflammation (comorbidities → low-grade inflammation → ↓ NO
    bioavailability → ↓ cGMP → ↓ PKG → ↑ myocyte passive stiffness)
  - Coronary microvascular dysfunction (endothelial inflammation, rarefaction)
  - Myocardial fibrosis (collagen, titin changes)
   ↓
LV remodelling:
  - Concentric LV hypertrophy
  - Increased LV stiffness (reduced diastolic compliance)
  - Reduced LV systolic reserve (blunted contractile response to exercise)
   ↓
Haemodynamics:
  - Elevated filling pressures at rest and/or exercise (PCWP elevation)
  - Pulmonary hypertension (secondary to chronically elevated PCWP)
  - Reduced cardiac output reserve on exercise
   ↓
Clinical syndrome:
...
**RAAS blockade — four trials, all failed:**

| Trial | Drug | LVEF | Primary HR | P | Notes |
|---|---|---|---|---|---|
| [[charm-preserved]] | Candesartan | >40% | 0.89 | 0.12 | HF hosp signal HR 0.83, P=0.04 |
| PEP-CHF | Perindopril | >40% | 0.92 | 0.55 | Elderly ≥70y; substantial drug discontinuation |
...
- EMPEROR-Preserved: empagliflozin (→ [[anker2021emperor]])
- DELIVER: dapagliflozin (→ [[solomon2022deliver]])

**Device trials ongoing at time of writing:**
...
Primary pathophysiology synthesis for the wiki. Provides:
- Most complete mechanistic cascade model (Figure 2) — canonical for [[hfpef]], [[diastolic-dysfunction]], [[exercise-intolerance]]
- cGMP/PKG/systemic inflammation paradigm — extends [[diastolic-dysfunction]] cellular section
- ATTR 13–19% prevalence in HFpEF — updates [[hfpef]] entity and amyloid considerations in [[hfpef-diagnosis]]
- PEP-CHF trial data — adds to [[hfpef-treatment-gap]] failed trials catalogue
- CHAMPION trial data — adds haemodynamic monitoring to [[hfpef-treatment-gap]] treatment section
- SECRET trial — adds caloric restriction + exercise combination to [[exercise-intolerance]] evidence
- TOPCAT Americas detail — deepens [[topcat]] entity narrative
- SPRINT/SHEP/HYVET/ALLHAT prevention data — new HFpEF prevention subsection
...
- Supports: [[charm-preserved]] — HR 0.89, HF hosp signal HR 0.83
- Anticipates: [[anker2021emperor]], [[solomon2022deliver]], [[solomon2019paragon]] — all listed as ongoing Phase 3 trials
...
## Contradictions
- LVEF >40% threshold chosen for CHARM-Preserved for practical design reasons, not biological boundary — consistent with wiki position on arbitrary thresholds. See [[contradictions]].
- TOPCAT Americas positive vs. Russia/Georgia neutral: Pfeffer 2019 provides the most detailed description of the regional non-compliance evidence in the wiki. See [[topcat]] and [[contradictions]].
- cGMP/PKG paradigm: explains RAAS trial failures in HFpEF (mechanism mismatch) but also the failure of NO-targeting nitrate trials (NEAT-HFpEF, INDIE-HFpEF) — vascular NO delivery alone is insufficient; cellular cGMP/PKG deficiency requires a different approach. See [[contradictions]].
