...
- PROSPERO CRD42024562698; search up to June 27, 2024; PubMed/Medline + Embase
- Included: prospective cohort studies; HFpEF patients ≥18 years; systemic inflammatory marker exposure; at least 365-day follow-up
- Quality: Newcastle-Ottawa Scale (NOS) — all studies high quality (scores 7–9)
- Analysis: fixed-effects model (I²<50%); Stata 17.0

---

## Included Studies

| Study | Nation | N | Marker | Follow-up |
|---|---|---|---|---|
| Tamaki et al. | Japan | 1,026 | NLR, PLR | 429 d |
| Yano et al. | Japan | 796 | HDL-C/CRP | 420 d |
| Ferreira et al. | France | 232 | hs-CRP | 3.3 yr |
| Zhou et al. | China | 3,459 | hs-CRP | 3.2 yr |
...
- Supports: [[hfpef]] — systemic inflammation as a prognostic driver
- Updates: [[overview]] — inflammatory markers predict mortality and rehospitalisation in HFpEF
...
I²=0% across all outcomes is unusually low for a meta-analysis of diverse populations and measurement methods — may reflect limited study numbers (8 studies) and publication bias favouring significant results. See [[contradictions]].
