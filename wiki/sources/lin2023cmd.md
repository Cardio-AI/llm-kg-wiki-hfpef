...
| Study | N (HFpEF) | CMD assessment | Prevalence |
|---|---|---|---|
| Kato 2015 | 25 | MRI, CFR<2.5 | 76% |
| Srivaratharajah 2016 | 78 | PET, CFR<2.0 | 40% |
| Dryer 2018 | 30 | Invasive, CFR≤2.0 or IMR≥23 | 73% |
| Shah 2018 | 202 | TDE, CFR<2.5 | 75% |
| Löffler 2019 | 19 | IMR, MPR<2.5 | 69% |
| Yang 2020 | 162 | Invasive, endothelium-dep/indep | 72% |
| Mahfouz 2020 | 77 | TDE, CFR<2.0 | 66% |
| Ahmad 2021 | 22 | Invasive | 86% |
...
- Establishes CMD as a near-ubiquitous finding in HFpEF (71%), supporting CMD as a core pathophysiological feature rather than an incidental comorbidity
- Provides quantitative basis for CMD-HFpEF phenotyping ([[anker2023hfpefphenotype]])
- Relevant to pending trial CoIPET (coronary physiology in invasive CPET in HFpEF with CMD); see [[trials-pending]]
...
High heterogeneity (I²=80.9%) reflects differences in CMD measurement methods (invasive vs non-invasive, different cut-offs) and patient populations. Prevalence estimates should not be applied indiscriminately across measurement contexts. See [[contradictions]].
